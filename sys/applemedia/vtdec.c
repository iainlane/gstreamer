    ...
    GstBuffer * codec_data)
{
  ...
  gst_vtutil_dict_set_i32 (par, CFSTR ("HorizontalSpacing"), self->vinfo.par_n);
  gst_vtutil_dict_set_i32 (par, CFSTR ("VerticalSpacing"), self->vinfo.par_d);
...
gst_vtdec_create_session (GstVTDec * self, CMFormatDescriptionRef fmt_desc)
{
  ...
  gst_vtutil_dict_set_i32 (pb_attrs, kCVPixelBufferWidthKey, self->vinfo.width);
